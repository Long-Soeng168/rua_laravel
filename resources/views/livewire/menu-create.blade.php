<div>
    ...
    <form class="w-full" action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid mb-5 lg:grid-cols-2 lg:gap-6">
                ...
                <div class="flex flex-1 gap-1 mt-1">
                    <div class="flex justify-start flex-1">
                        <x-select-option wire:model.live='position' id="position"
                            name="position">
                            <option wire:key='bottom' value="bottom">bottom</option>
                            <option wire:key='top' value="top">top</option>
                        </x-select-option>
                    </div>
            ...
            <!-- End Name -->
            <div>
                <x-input-label for="is_show_dropdown" :value="__('Is Show Dropdown')" />
                <span class="text-red-500">* </span>
                <!-- Switch/Toggle -->
                <label class="flex items-center mt-1 cursor-pointer">
                    <input type="checkbox" class="sr-only peer" wire:model='is_show_dropdown'>
                ...
                <!-- End Switch/Toggle -->
                <x-input-error :messages="$errors->get('is_show_dropdown')" class="mt-2" />
            </div>
