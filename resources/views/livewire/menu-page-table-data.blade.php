<div>
    ...
    <div
                ...
                <div>
                    <button id="filterDropdownButton" data-dropdown-toggle="filterDropdown"
                        ...
                        <p class="w-full text-left line-clamp-1">
                            {{ $selectedCategory ? $selectedCategory->name : 'Menus' }}
                        </p>
                    ...
                    <div id="filterDropdown" class="z-10 hidden p-3 bg-white rounded-lg shadow w-72 dark:bg-gray-700">
                        <h6 class="mb-3 text-sm font-bold text-gray-900 dark:text-white">Filter by menu</h6>
        ...
        <div
            ...
            @can('create faculty')
                <x-primary-button href="{{ route('admin.menus_pages.create') }}">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-start justify-center gap-3">
                                ...
                                @can('update faculty')
                                    <div class="pb-1" x-data="{ tooltip: false }">
                                        <!-- Modal toggle -->
                                        <a href="{{ url('admin/menus_pages/' . $item->id . '/edit') }}"
