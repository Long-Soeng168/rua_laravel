    ...
    <div
            ...
            <form class="flex items-center gap-4">
                ...
                <div>
                    <button id="filterDropdownButton" data-dropdown-toggle="filterDropdown"
                        class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg md:w-[300px] focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                        type="button">
                        ...
                        <p class="w-full text-left line-clamp-1">
                            {{ $selectedCategory ? $selectedCategory->name : 'Faculties' }}
                        </p>
                    ...
                    <div id="filterDropdown" class="z-10 hidden p-3 bg-white rounded-lg shadow w-72 dark:bg-gray-700">
                        <h6 class="mb-3 text-sm font-bold text-gray-900 dark:text-white">Filter by Faculty</h6>
        ...
        <div
            ...
            @can('create epublication')
                <x-primary-button href="{{ route('admin.faculties_pages.create') }}">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-4 py-3 text-center">Children Type</th>
            ...
            <tbody>
                @forelse ($items as $item)
                    <tr wire:key='{{ $item->id }}'
                        ...
                        <x-table-data>
                            <span
                                class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300 line-clamp-2">
                                {{ $item->faculty?->name ? $item->faculty?->name : 'N/A' }}
                            </span>
                        </x-table-data>
                        <x-table-data value="{{ $item->parent?->name ? $item->parent?->name : 'N/A' }}" />
                        <x-table-data class="text-center capitalize " value="{{ $item->type }}" />
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-start justify-center gap-3">
                                ...
                                @can('update epublication')
                                    <div class="pb-1" x-data="{ tooltip: false }">
                                        <!-- Modal toggle -->
                                        <a href="{{ url('admin/faculties_pages/' . $item->id . '/edit') }}"
