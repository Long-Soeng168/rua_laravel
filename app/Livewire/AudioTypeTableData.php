...
use App\Models\AudioType as Type;

class AudioTypeTableData extends Component
{
    use WithPagination;
    ...
    public function delete($id)
    {
     ...
     public function save()
     {
         try {
             $validated = $this->validate([
                 'newName' => 'required|string|max:255|unique:audio_types,name',
     ...
     public function update($id) {
        try {
            $validated = $this->validate([
                'name' => 'required|string|max:255|unique:audio_types,name,' . $id,
    ...
    public function render(){
        ...
        return view('livewire.audio-type-table-data', [
            'items' => $items,
        ]);
    }
}
