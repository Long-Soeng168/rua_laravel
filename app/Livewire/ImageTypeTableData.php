...
use App\Models\ImageType as Type;

class ImageTypeTableData extends Component
{
    use WithPagination;
    ...
    public function delete($id)
    {
     ...
     public function save()
     {
         try {
             $validated = $this->validate([
                 'newName' => 'required|string|max:255|unique:image_types,name',
     ...
     public function update($id) {
        try {
            $validated = $this->validate([
                'name' => 'required|string|max:255|unique:image_types,name,' . $id,
    ...
    public function render(){
        ...
        return view('livewire.image-type-table-data', [
            'items' => $items,
        ]);
    }
}
